...
import { Status } from 'src/features/appointments/entities/appointment.entity';
...
export class PaymentsService {
  ...
  async verifySignature(dto: VerifyPaymentDto) {
    ...
    const orderDetails = await this.razorpay.orders.fetch(dto.externalOrderId);
    ...
    if (orderDetails.status === 'paid') payment.status = PaymentStatus.PAID;
